...
@interface DoImagePickerController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
- (void)viewDidLoad
{
    ...
    view.backgroundColor = KGColorFrom16(0xF54B68);
    ...
    UINib *zeroNib = [UINib nibWithNibName:@"ZeroCameraCell" bundle:nil];
    [_cvPhotoList registerNib:zeroNib forCellWithReuseIdentifier:@"ZeroCameraCell"];
    
    UICollectionViewFlowLayout *layout = [[UICollectionViewFlowLayout alloc] init];
    layout.sectionInset = UIEdgeInsetsMake(10, 10, 10, 10);
    _cvPhotoList.collectionViewLayout = layout;
...
- (void)initBottomMenu
{
    _vBottomMenu.backgroundColor = [UIColor grayColor];//DO_MENU_BACK_COLOR;
...
//    UIImageWriteToSavedPhotosAlbum(image, nil, nil, nil);
    [picker dismissViewControllerAnimated:NO completion:^{
        if (_delegate && [_delegate respondsToSelector:@selector(simpleShowImageWithArray:)]) {
            [_delegate simpleShowImageWithArray:@[image]];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    DoPhotoCell * cell;
    if (indexPath.row != 0) {
        cell = (DoPhotoCell *)[_cvPhotoList dequeueReusableCellWithReuseIdentifier:@"DoPhotoCell" forIndexPath:indexPath];
    ...
    if (indexPath.row == 0) {
        ZeroCameraCell * cell = (ZeroCameraCell *)[_cvPhotoList dequeueReusableCellWithReuseIdentifier:@"ZeroCameraCell" forIndexPath:indexPath];
        return cell;
    }

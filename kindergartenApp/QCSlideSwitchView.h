...
@property (nonatomic, assign) BOOL isShowAllTab;
 ...
 */
- (QCSlideSwitchDto *)slideSwitchView:(QCSlideSwitchView *)view viewOfTab:(NSUInteger)number;
 ...
 *  当视图开始滚动时
 */
- (void)slideSwitchWillBeginScroll;
